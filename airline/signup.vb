...
Public Class signup
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        If TextBox1.Text = "Match" Then
            Try
                Dim connection1 As New SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=D:\ITS\SEMESTER 6\PBKK\ETS\airline_reservation_system_vb.net__0\Airline Reservation System VB.Net\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True")
                connection1.Open()
